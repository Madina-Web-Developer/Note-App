...
const Addcard = () => {
  ...
  return (
    ...
    <div>
        <div onClick={()=>setshow(true)} className="mina_card   w-[200px] h-[200px] border-[1px] bg-[rgb(251,253,255)] dark:bg-gray-200 rounded-md flex gap-1 justify-center items-center dark:border-[#b16154] border-[rgb(255,185,174)]
